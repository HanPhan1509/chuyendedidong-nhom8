...
//                adapcay.filter(s.trim());
    ...
    private List<SlidePhoto> getListSlidePhoto() {
        ...
        listSlidePhoto.add(new SlidePhoto("https://bizweb.dktcdn.net/100/347/092/files/giay-sneaker-la-gi-1.jpg?v=1599104032003"));
        listSlidePhoto.add(new SlidePhoto("https://anchuongshoes.vn/wp-content/uploads/2020/05/giay-sneaker-mlb-la-dodgers.jpg"));
        listSlidePhoto.add(new SlidePhoto("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa2R938OeF13qsa1BTL6kJdl2IrK0jfRbWAe4WY3RwbprvKSFXoBnDU5E1wKw8IS-G2Yc&usqp=CAU"));
        listSlidePhoto.add(new SlidePhoto("https://chuyensituixach.com/wp-content/uploads/2020/12/67.png"));
        listSlidePhoto.add(new SlidePhoto("http://www.elleman.vn/wp-content/uploads/2017/08/21/giay-the-thao-ugly-sneakers-balenciaga-triple-s-elle-man-2.png"));
        listSlidePhoto.add(new SlidePhoto("https://mudi.vn/blog/wp-content/uploads/2021/02/mau-giay-sneaker.jpg"));
        listSlidePhoto.add(new SlidePhoto("https://tienloimart.vn/wp-content/uploads/2020/09/giay-sneaker-nu-tot-nhat-1-1024x536.jpg"));
